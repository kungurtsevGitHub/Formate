 ...
 */
public class ArithmeticalOperatorAfterEmptySymbol implements InterfaceState {
    public static InterfaceState Instance() {
        return new ArithmeticalOperatorAfterEmptySymbol();
    }
    ...
    public String toString() {
        return "ArithmeticalOperatorAfterEmptySymbol";
    }
}
